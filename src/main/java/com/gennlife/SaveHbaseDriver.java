...
//        conf.set("hbase.zookeeper.quorum","192.168.187.21,192.168.187.22,192.168.187.23");        //本地
        ...
        FileInputFormat.setMaxInputSplitSize(job,1024*1024*500);
        FileInputFormat.setMinInputSplitSize(job,1024*1024*400);
        ...
        FileInputFormat.setMaxInputSplitSize(indexJob,1024*1024*500);
        FileInputFormat.setMinInputSplitSize(indexJob,1024*1024*400);
